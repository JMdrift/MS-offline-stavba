...
const StagesListScreen = (function(){
  function render(container){
    container.innerHTML = `
      <div class="topbar ms-ui-topbar stages-list-v2-topbar">
        ...
        <div class="ms-ui-title"><p>Pořadí stavby</p><h1>Přehled etap</h1></div>
      </div>
      <div class="screen-scroll stages-list-v2-scroll">
        <div class="queue-v2-info"><b>Pořadí etap</b><span>Klepnutím otevřeš detail, tažením za ⋮ změníš pořadí.</span></div>
        <div id="list"></div>
      </div>
    `;
    ...
    function draw(){
      ...
      keys.forEach((key, idx)=>{
        ...
        row.className = 'stages-list-v2-row';
        row.dataset.key = key;
        ...
        function endDrag(){
          ...
          dragState = null;
          if(wasMoved){
            const newOrder = [...list.children].map(r=>r.dataset.key);
    ...
    function menuChoice(isCur, isClosed){
      return new Promise(resolve=>{
        ...
        overlay.innerHTML = `
          <div style="width:100%;max-width:480px;background:var(--card-bg-2);border-top:1px solid var(--line);padding:8px 0 calc(8px + var(--safe-area-inset-bottom, env(safe-area-inset-bottom, 0px)))">
